...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () => import('./create-game/create-game').then((m) => m.CreateGame),
  },
  {
    path: 'games/:id',
    loadComponent: () => import('./game-detail/game-detail').then((m) => m.GameDetailComponent),
  },
  {
    path: 'seasons',
    canActivate: [adminGuard],
    loadComponent: () => import('./season-manager/season-manager').then((m) => m.SeasonManager),
  },
  {
    path: 'leaderboard',
